...
public class MyLinkedList {
	...
	public Object removeFirst() throws Exception {
		 if(this.size< 0) {
	      ...
	      ListNode temp= this.head.next;
	      		...
	      		this.size--;
			return temp.data; //change this as you need.
		}
	...
	{
		if(index < 0 || index > this.size ) throw new IndexOutOfBoundsException("bad size");
		...
		ListNode  nn= new ListNode(o), cur=this.head.next,prev=this.head;
	...
	public Object get(int index) throws IndexOutOfBoundsException{
        ...
        return cur.next.data; //change this as you need.
	}
	...
	public Object remove(int index) throws IndexOutOfBoundsException {
		if (index < 0 ||index >= this.size)throw new IndexOutOfBoundsException("bad index");
...
///---================================================================================
	...
	public boolean add(Object e) {
		ListNode nn = new ListNode(e),cur = this.head;
